...
export const sourceConfigs: SourceConfig[] = [
  ...
  },
  {
    ...
    mode: "otomatis",
    group: "perhiasan",
    selectorSummary: "Tab PERHIASAN, endpoint harga-emas-fisik/brand/perhiasan, tabel Kadar vs Harga Jual/ Gram",
    parserType: "laku-emas",
    titleSelector: "#perhiasan",
    dataSelector: "#priceList table.table-bordered",
    rowSelector: "table.table-bordered tbody tr",
    fieldMapping: { weightIndex: 0, priceIndex: 1, productTypeIndex: 0 },
    elementKeywords: ["showPrice('perhiasan')", "Kadar", "Harga Jual/ Gram"],
    includeKeywords: ["K", "Rp"],
    excludeKeywords: ["ANTAM CERTIEYE", "ANTAM RETRO", "STAR GOLD", "LM OTHERS"],
    boundaryStartKeywords: ["Kadar", "Harga Jual/ Gram"],
    boundaryStopKeywords: ["*Harga Dapat Berubah Sewaktu Waktu"],
    priceCurrency: "IDR"
  },
  {
    name: "BSI",
