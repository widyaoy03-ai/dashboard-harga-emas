...
export const sourceConfigs: SourceConfig[] = [
  ...
  {
    name: "Raja Emas",
    url: "https://rajaemas.id/",
    mode: "otomatis",
    group: "perhiasan",
    selectorSummary: "#hargaemas dan tabel kadar karat",
    titleSelector: "#hargaemas",
    dataSelector: "table kadar karat",
    elementKeywords: ["hargaemas", "Harga Beli Emas", "Kadar Karat"],
    priceCurrency: "IDR"
  },
  {
    name: "Laku Emas",
